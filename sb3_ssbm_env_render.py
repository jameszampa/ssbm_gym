...
class CustomEnv(SSBMEnv):
    def __init__(self, **kwargs):
        ...
        spaces = {
            'player0_character': gym.spaces.Box(low=0, high=1, shape=(numCharacters,)),
            'player0_action_state': gym.spaces.Box(low=0, high=1, shape=(numActions,)),
            'player0_state': gym.spaces.Box(low=0, high=1, shape=(10,)),
            'player1_character': gym.spaces.Box(low=0, high=1, shape=(numCharacters,)),
            'player1_action_state': gym.spaces.Box(low=0, high=1, shape=(numActions,)),
            'player1_state': gym.spaces.Box(low=0, high=1, shape=(10,)),
            'stage': gym.spaces.Box(low=0, high=1, shape=(numStages,)),
        }
        print('numActions')
